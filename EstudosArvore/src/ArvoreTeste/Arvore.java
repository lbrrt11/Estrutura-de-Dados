...
public class Arvore <TIPO extends Comparable> {
    ...
    public void adicionar(TIPO valor)
    {
        ...
        if (raiz == null){    // Caso árvore vazia
            ...
            while(true){ //roda constante entrando nos niveis da arvore - Para com break 
                // ------------- Novo elemento MENOR
    ...
    public  Elemento<TIPO> adicionarRec(TIPO valor, Elemento<TIPO> raizAtual){
       ...
       // Raiz atual vaiza salva
        ...
        // Retorna para o pai o novo elemento criado, ou o já existente nessa posição
        return raizAtual; 
    }
